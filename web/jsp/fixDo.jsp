            	...
            	<div class="table-responsive">
			 		  <table class="layui-table" lay-skin="line" lay-size="lg" id="table">						  
						  ...
						  <sql:query dataSource="${snapshot}" var="fixorder">
                                SELECT * from repairorder where SERVICE_USER = ${sessionScope.nowuser.id } and STATUS=0
                           </sql:query>
						    ...
						    <tr>
						      ...
						      <td>第<c:out value="${fix.equipment_build}"/>号楼第<c:out value="${fix.equipment_build}"/>层</td>
						    ...
						    <td>	      	  
						      	  <div id="layer-photos-demo" class="layer-photos-demo">
								      <img layer-pid="" layer-src="" src="../${fix.IMAGE}" alt="图片名">
								  </div>
						    </td>
						    ...
						    <td class="layui-form">
								  ...
								  <div class="mbrt layui-col-xs6 layui-col-md6">
								   <c:url var="myURL" value="orderDo.jsp">
                                            <c:param name="id" value="${fix.id}"/>
                                            <c:param name="name" value="${fix.equipment_name }"/>
                                            <c:param name="pep" value="${fix.repair_user }"/>
                                   </c:url>
    			                    <a href="<c:out value="${myURL}"/>" class="layui-btn layui-btn-normal" id="share">填写回执</a>    			     			 
    		                      </div>
